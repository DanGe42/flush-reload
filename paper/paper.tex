...
duration of spying, which in the case of the figure~\ref{fig:data-arch}, occurred roughly
...
this would change the output this drastically, or if it did at all.

Two additional hypotheses for why this behaviour was exhibited were that Arch Linux
